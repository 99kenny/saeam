...
class App(QWidget):
    ...
    def make_ppt(self, list):
        ...
        for i in range(len(list)):
            ...
            temp = seperated[2].strip().split(" ")    # 요 6_61~63, 계 2 fix here
            ...
            self.text_on_shape(shape_list[shape_index["words"]], words + " " + chapter + "장 " + clause + "절",
                          RGBColor(181, 251, 5))
            ...
            self.text_on_shape(shape_list[shape_index["title"]], "'" + contents + "' ", RGBColor(255, 255, 255),
                          font_size=28)
            self.text_on_shape(shape_list[shape_index["title"]], words + " " + chapter + "장 " + clause + "절",
            ...
            self.text_on_shape(shape_list[shape_index["new_translation"]], saenew, RGBColor(255, 255, 255))
            self.text_on_shape(shape_list[shape_index["revision"]], gae, RGBColor(204, 255, 204))
